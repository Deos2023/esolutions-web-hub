      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center mb-10">
            <div>
              <h2 className="text-3xl font-bold mb-3 text-esolutions-darkBlue">Our Office Gallery</h2>
            ...
            <Link 
              to="/gallery" 
              className="flex items-center text-esolutions-blue hover:text-esolutions-red font-medium"
            >

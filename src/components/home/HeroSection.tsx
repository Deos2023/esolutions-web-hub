  ...
  return (
    <section className="relative bg-esolutions-darkBlue text-white overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(34,56,145,0.7) 0%, rgba(217,35,34,0.5) 100%)",
        }}
      ></div>
      ...
      <div className="container mx-auto px-4 py-28 md:py-40 relative z-10">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 animate-fadeInRight">
            Your <span className="text-esolutions-red">Complete Tax</span> &
            Business Solution Provider
          </h1>
          <p className="text-lg md:text-xl mb-8 text-gray-200 animate-fadeInRight delay-200">
            With over 45 years of experience, ESOLUTION provides comprehensive
            tax and business services under one roof.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 animate-fadeInRight delay-300">
            <Button
              asChild
              className="bg-white text-esolutions-darkBlue hover:bg-esolutions-blue hover:text-white button-premium"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="bg-transparent border-white text-white hover:bg-white/10 button-premium"
            >
